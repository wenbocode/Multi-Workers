...
const TIMI_BASE_URL = "http://api.timiai.woa.com/ai_api_manage/llmproxy";
const TIMI_ZERO_COST: ModelCost = {
	input: 0,
	output: 0,
	cacheRead: 0,
	cacheWrite: 0,
};
const TIMI_RESPONSES_COMPAT: OpenAIResponsesCompat = {
...
const TIMI_ANTHROPIC_COMPAT: AnthropicMessagesCompat = {
	supportsLongCacheRetention: false,
	supportsEagerToolInputStreaming: false,
	supportsCacheControlOnTools: false,
};
const TIMI_MODELS: Model<Api>[] = [
	{
		id: "claude-haiku-4.5",
