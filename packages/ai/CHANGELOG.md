...
- Added timi proxy models `gpt-6-astra` (openai-responses, reasoning, text+image), `deepseek-v4-flash-vision-exp` (anthropic-messages, text+image), `glm-5.3-flash` (anthropic-messages), and `deepseek-v4.1-flash` (anthropic-messages, text-only, 200K/64K, mirroring the deepseek flash family).
