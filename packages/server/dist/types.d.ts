import type { Command, ModelMetadata, ModelRef, SessionPhase, SessionSnapshot, SessionSummary, ThinkingLevel, TranscriptProgress } from "@earendil-works/pi-protocol";
...
export type PromptInput = Omit<Extract<Command, {
    command: "prompt";
}>, "command" | "sessionId">;
export type SteerInput = Omit<Extract<Command, {
    command: "steer";
}>, "command" | "sessionId">;
