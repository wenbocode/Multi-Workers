 ...
 */
export declare const RAG_FALLBACK = "rag_fallback";
export declare const RAG_UNAVAILABLE = "rag-unavailable";
export declare const RAG_REWRITE_DEGRADED = "rag-rewrite-degraded";
export declare const RAG_REQUIRED_MISSING = "rag-required-missing";
export declare const RAG_BUDGET_EXCEEDED = "rag-budget-exceeded";
 ...
 */
export declare function ragCallLine(e: RagCallEvidence): string;
/** `rag_fallback server=<S> tool=<T> via=cli reason=<K>` (D-005 read-only connect). */
export declare function ragFallbackLine(e: {
    server: string;
    tool: string;
    reason: string;
}): string;
/** `rag-unavailable server=<S> tool=<T> kind=<K> ms=<N>` — no usable transport. */
export declare function ragUnavailableLine(e: {
    server: string;
    tool: string;
    kind: string;
    ms: number;
 ...
 */
export declare function ragBudgetExceededLine(e: {
    server: string;
    tool: string;
...
export declare function ragRewriteDegradedLine(e: {
    server: string;
    tool: string;
}): string;
/**
 ...
 */
export declare function ragRequiredMissingLine(e: {
    role: string;
    phase: string;
    server: string;
}): string;
 ...
 */
export declare function appendEvidence(taskDir: string, line: string): void;
/**
 ...
 */
export declare function redactSecrets(text: string, tokenEnvNames: string[]): string;
